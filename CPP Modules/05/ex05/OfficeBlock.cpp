...
const Bureaucrat*
OfficeBlock::getExecutor() const
{
	return _executor;
}

const Intern*
OfficeBlock::getIntern() const
{
	return _intern;
}

const Bureaucrat*
OfficeBlock::getSigner() const
{
	return _signer;
}
...
Intern *
OfficeBlock::removeIntern()
{
	Intern *ptr = this->_intern;
