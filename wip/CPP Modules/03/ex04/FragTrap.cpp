...
FragTrap::FragTrap(std::string name) : ClapTrap(name)
{
	...
	std::cout << this->_name << ": [FragTrap] ready!" << std::endl;
}
...
{
	std::cout << this->_name << ": [FragTrap] ranged attacked " << target << ", damage = " << this->_rangedAttackDamage << "." << std::endl;
}

void
FragTrap::meleeAttack(std::string const &target)
{
	std::cout << this->_name << ": [FragTrap] melee attacked " << target << ", damage = " << this->_meleeAttackDamage << "." << std::endl;
}
