...
const ChannelPromoteUserView = ChannelBaseActionView.extend({
  template: _.template($("script[id='template-channel-promote']").html()),
  initialize() {
...
export default ChannelPromoteUserView;
