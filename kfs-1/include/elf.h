...
typedef struct elf32_sym
{
		...
		Elf32_Addr st_value; /* Type and binding attributes */
		Elf32_Word st_size; /* No defined meaning, 0 */
		unsigned char st_info; /* Associated section index */
		unsigned char st_other; /* Value of the symbol */
		Elf32_Half st_shndx; /* Associated symbol size */
} Elf32_Sym;
